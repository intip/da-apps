...
select_conteudo = """
    SELECT 
        N.id_conteudo, N.titulo, N.nome, N.descricao, N.resposta,   
...
insert_conteudo = """
    INSERT INTO
        rschemar.conteudo (id_conteudo, nome, resposta, titulo, descricao,
        publicado_em, expira_em, publicado) 
    VALUES (%(id_conteudo)i, %(nome)s, %(titulo)s,%(resposta)s, %(descricao)s, %(publicado_em)s, %(expira_em)s, %(publicado)s)
"""
...
update_conteudo = """
    UPDATE 
        ...
        descricao=%(descricao)s, resposta=%(resposta)s, publicado_em=%(publicado_em)s, 
