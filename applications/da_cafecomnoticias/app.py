...
haslist = True
haslink = True
title = "DA-Cafe_com_noticias"
meta_type = "da_cafecomnoticias"
...
class App(BaseApp, PortalUtils, Adm, Public):
    ...
    @dbconnectionapp
    def _install(self, title, redimensionamento, dimenx, dimeny,
        ...
        return {"redimensionamento":redimensionamento,
                "dimenx":dimenx,
                "dimeny":dimeny,
                "rss":rss}
    ...
    @serialize
    @Permission("ADM APP")
    def editApp(self, title, redimensionamento, dimenx, dimeny,
                       rss_titulo=None, rss_link=None, rss_descricao=None,
                       rss_idioma=None, rss_categoria=None, rss_copyright=None,
                       rss_imagem_titulo=None, rss_imagem_link=None,
                       rss_imagem=None):
        ...
        dados = {"redimensionamento":redimensionamento,
                "dimenx":dimenx,
                "dimeny":dimeny,
                "rss":rss}
