...
select_conteudo_         = ("SELECT C.titulo, C.descricao, C.imagem_destaque, "
                            "C.titulo_destaque, C.descricao_destaque, C.link_destaque, "
                            "C.publicado, "
...
select_conteudo          = ("SELECT C.id_conteudo, C.titulo, C.descricao, C.imagem_destaque, "
                            "C.titulo_destaque, C.descricao_destaque, C.link_destaque, "
                            "C.publicado, "
...
select_conteudo2         = ("SELECT C.id_conteudo, C.titulo, C.descricao, C.imagem_destaque, "
                            "C.titulo_destaque, C.descricao_destaque, C.link_destaque, "
                            "C.publicado, "
                            "to_char(C.publicado_em, 'DD/MM/YYYY HH24:MI') as publicado_em, "
                            "to_char(C.expira_em, 'DD/MM/YYYY HH24:MI') as expira_em, "
...
insert_conteudo          = ("INSERT INTO rschemar.conteudo (id_conteudo, titulo, "
                            "descricao, imagem_destaque, titulo_destaque, "
                            "descricao_destaque, link_destaque, publicado, "
                            "publicado_em, expira_em) VALUES "
                            "(%(id_conteudo)i, %(titulo)s, %(descricao)s, "
                            "%(imagem)s, %(titulo)s, %(descricao)s, %(link)s, "
...
update_conteudo          = ("UPDATE rschemar.conteudo SET titulo=%(titulo)s, "
                            "descricao=%(descricao)s, imagem_destaque=%(imagem)s, "
                            "titulo_destaque=%(titulo)s, descricao_destaque=%(descricao)s, "
                            "link_destaque=%(link)s, publicado=%(publicado)s, "
...
structure = """
  ...
  CREATE TABLE rschemar.conteudo (
    ...
    imagem_destaque VARCHAR NOT NULL,
    titulo_destaque VARCHAR NOT NULL,
    descricao_destaque VARCHAR NOT NULL,
    link_destaque VARCHAR NOT NULL,
  ...
  INSERT INTO rschemar.tipos (id_tipo, nome) VALUES (1, 'Principal'), 
    (2, 'Destaque'), (3, 'Lista1'), (4, 'Lista2'), (5, 'Complemento');
