...
select_categoria_bar=("SELECT C.id_categoria, C.nome FROM rschemar.categoria C JOIN rschemar.bar_categoria B "
                      "ON (C.id_categoria=B.id_categoria) AND B.id_conteudo=%(id_conteudo)i")

select_regiao_bar=("SELECT id_regiao, nome FROM rschemar.regiao WHERE id_regiao=%(id_regiao)s")
...
select_bar_publicado = ("SELECT E.id_conteudo, E.titulo, E.pagamento, E.descricao, "
...
select_bar_nome = ("SELECT E.id_conteudo, E.titulo, E.pagamento, E.descricao, "
"E.observacao, E.publicado, R.nome as regiao,"
" to_char(E.publicado_em, 'dd/mm/YYYY HH24:MI') as publicado_em, E.endereco,"
...
select_bar_categoria = ("SELECT E.id_conteudo, E.titulo, E.pagamento, E.descricao, "
"E.observacao, E.publicado, R.nome as regiao,"
" to_char(E.publicado_em, 'dd/mm/YYYY HH24:MI') as publicado_em, E.endereco,"
" E.img, E.credito, E.editor, E.id_regiao, E.telefone, E.telefonec, E.site, E.estado, E.rua, E.num,"
" E.bairro, E.cep, E.capacidade, E.cadeirantes, E.lat, E.lng, E.cidade,"
...
" FROM rschemar.conteudo E"
" INNER JOIN rschemar.destaque D ON (E.id_conteudo=D.id_conteudo)"
" LEFT JOIN rschemar.bar_categoria B ON (B.id_conteudo=E.id_conteudo)"
" LEFT JOIN rschemar.regiao R ON (E.id_regiao=R.id_regiao)"
" WHERE id_categoria=%(categoria)s AND E.publicado=True AND E.publicado_em <= now() AND"
" (E.expira_em IS NULL OR E.expira_em > now())"
" ORDER BY E.publicado_em DESC LIMIT %(limit)i OFFSET %(offset)i")

select_bar_categoria_regiao = ("SELECT E.id_conteudo, E.titulo, E.pagamento, E.descricao, "
"E.observacao, E.publicado, R.nome as regiao,"
" to_char(E.publicado_em, 'dd/mm/YYYY HH24:MI') as publicado_em, E.endereco,"
" E.img, E.credito, E.editor, E.id_regiao, E.telefone, E.telefonec, E.site, E.estado, E.rua, E.num,"
" E.bairro, E.cep, E.capacidade, E.cadeirantes, E.lat, E.lng, E.cidade,"
...
select_bar_categoria_regiao_nome = ("SELECT E.id_conteudo, E.titulo, E.pagamento, E.descricao, "
"E.observacao, E.publicado, R.nome as regiao,"
" to_char(E.publicado_em, 'dd/mm/YYYY HH24:MI') as publicado_em, E.endereco,"
" E.img, E.credito, E.editor, E.id_regiao, E.telefone, E.telefonec, E.site, E.estado, E.rua, E.num,"
" E.bairro, E.cep, E.capacidade, E.cadeirantes, E.lat, E.lng, E.cidade,"
...
select_bar_nome_categoria = ("SELECT E.id_conteudo, E.titulo, E.pagamento, E.descricao, "
"E.observacao, E.publicado, R.nome as regiao,"
" to_char(E.publicado_em, 'dd/mm/YYYY HH24:MI') as publicado_em, E.endereco,"
" E.img, E.credito, E.editor, E.id_regiao, E.telefone, E.telefonec, E.site, E.estado, E.rua, E.num,"
" E.bairro, E.cep, E.capacidade, E.cadeirantes, E.lat, E.lng, E.cidade,"
...
select_bar_nome_regiao = ("SELECT E.id_conteudo, E.titulo, E.pagamento, E.descricao, "
"E.observacao, E.publicado, R.nome as regiao,"
" to_char(E.publicado_em, 'dd/mm/YYYY HH24:MI') as publicado_em, E.endereco,"
" E.img, E.credito, E.editor, E.id_regiao, E.telefone, E.telefonec, E.site, E.estado, E.rua, E.num,"
" E.bairro, E.cep, E.capacidade, E.cadeirantes, E.lat, E.lng, E.cidade,"
...
select_bar_regiao = ("SELECT E.id_conteudo, E.titulo, E.pagamento, E.descricao, "
"E.observacao, E.publicado, R.nome as regiao,"
" to_char(E.publicado_em, 'dd/mm/YYYY HH24:MI') as publicado_em, E.endereco,"
" E.img, E.credito, E.editor, E.id_regiao, E.telefone, E.telefonec, E.site, E.estado, E.rua, E.num,"
" E.bairro, E.cep, E.capacidade, E.cadeirantes, E.lat, E.lng, E.cidade,"
...
select_bar_publicado_count = ("SELECT count(*) as qtde FROM rschemar.conteudo E"
" INNER JOIN rschemar.destaque D ON (E.id_conteudo=D.id_conteudo)"
" WHERE E.publicado=True AND E.publicado_em <= now() AND"
" (E.expira_em IS NULL OR E.expira_em > now())")

select_bar_nome_count = ("SELECT count(*) as qtde FROM rschemar.conteudo E"
" INNER JOIN rschemar.destaque D ON (E.id_conteudo=D.id_conteudo)"
" WHERE E.titulo ~* %(nome)s AND E.publicado=True AND E.publicado_em <= now() AND"
" (E.expira_em IS NULL OR E.expira_em > now())")

select_count_bar_categoria = ("SELECT count(*) as qtde FROM rschemar.conteudo E"
" INNER JOIN rschemar.destaque D ON (E.id_conteudo=D.id_conteudo)"
" LEFT JOIN rschemar.bar_categoria B ON (B.id_conteudo=E.id_conteudo)"
" WHERE id_categoria=%(categoria)s AND E.publicado=True AND E.publicado_em <= now() AND"
" (E.expira_em IS NULL OR E.expira_em > now())")

select_bar_nome_categoria_count = ("SELECT count(*) as qtde FROM rschemar.conteudo E"
" INNER JOIN rschemar.destaque D ON (E.id_conteudo=D.id_conteudo)"
" LEFT JOIN rschemar.bar_categoria B ON (B.id_conteudo=E.id_conteudo)"
" WHERE id_categoria=%(categoria)s AND E.titulo ~* %(nome)s AND E.publicado=True AND E.publicado_em <= now() AND"
" (E.expira_em IS NULL OR E.expira_em > now())")

select_count_bar_categoria_regiao = ("SELECT count(*) as qtde FROM rschemar.conteudo E"
" INNER JOIN rschemar.destaque D ON (E.id_conteudo=D.id_conteudo)"
" LEFT JOIN rschemar.bar_categoria B ON (B.id_conteudo=E.id_conteudo)"
" WHERE id_categoria=%(categoria)s AND E.id_regiao=%(regiao)i"
" AND E.publicado=True AND E.publicado_em <= now() AND"
...
select_count_bar_categoria_regiao_nome = ("SELECT count(*) as qtde FROM rschemar.conteudo E"
" INNER JOIN rschemar.destaque D ON (E.id_conteudo=D.id_conteudo)"
" LEFT JOIN rschemar.bar_categoria B ON (B.id_conteudo=E.id_conteudo)"
" WHERE id_categoria=%(categoria)s AND E.titulo ~* %(nome)s AND E.id_regiao=%(regiao)i"
" AND E.publicado=True AND E.publicado_em <= now() AND"
...
select_bar_nome_regiao_count = ( "SELECT count(*) as qtde FROM rschemar.conteudo E"
" INNER JOIN rschemar.destaque D ON (E.id_conteudo=D.id_conteudo)"
" WHERE E.titulo ~* %(nome)s AND E.id_regiao=%(regiao)i AND E.publicado=True AND E.publicado_em <= now() AND"
" (E.expira_em IS NULL OR E.expira_em > now())")

select_count_bar_regiao = ("SELECT count(*) as qtde FROM rschemar.conteudo E"
" INNER JOIN rschemar.destaque D ON (E.id_conteudo=D.id_conteudo)"
" WHERE E.id_regiao=%(regiao)s AND E.publicado=True  AND E.publicado_em <= now() AND"
" (E.expira_em IS NULL OR E.expira_em > now())")

select_bar_publicado_unico = ("SELECT E.id_conteudo, E.titulo, E.pagamento, E.descricao,"
...
insert_categoria_bar = ("INSERT INTO rschemar.bar_categoria VALUES (%(id_conteudo)i, %(id_categoria)i)")
...
delete_categoria_bar = ("DELETE FROM rschemar.bar_categoria WHERE id_conteudo=%(id_conteudo)i")
...
structure = """
  ...
  CREATE TABLE rschemar.bar_categoria (
     id_conteudo INT NOT NULL,
