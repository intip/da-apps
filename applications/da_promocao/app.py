...
class App(BaseApp, PortalUtils, Adm, Public):
    ...
    @dbconnectionapp
    def _install(self, title, auth, captcha, tipo, id_servico, 
    ...
    def retornarWidgets():
        ...
        return ({"action":"viewd",
                ...
                {"action":"view",
                 ...
                 "titulo":"Sortear",
                 "url":"listagemsorteio.env",
                 "target":"listagem" },
                {"action":"view",
                 "img":"/imgs/env.edit.png",
                 "titulo":"Participantes",
                 "url":"listagemusers.env",
                 "target":"listagem"},
                {"action":"view",
                 "img":"/imgs/env.statistics.png",
                 "titulo":"Relat&oacute;rios",
                 "url":"relatoriolistagem.env",
                 "target":"listagem"})
